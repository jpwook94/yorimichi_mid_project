        ...
        <div class="mypage-browser-window">
            <div class="mypage-title-bar">
                ...
                <div class="mypage-window-controls">
                    ...
                    <div class="mypage-control-btn">□</div>
                    <div class="mypage-control-btn" onclick="location.href='/gamelist'">×</div>
                </div>
            </div>
            ...
            <div class="mypage-toolbar">
                ...
                <input type="text" class="mypage-address-bar" value="" placeholder="주소를 입력하세요...">
            </div>

            <div class="mypage-content-area">
                <div class="mypage-sidebar">
                    <div class="mypage-sidebar-item" data-mycate="1"><p>내 찜 목록</p></div>
                    <div class="mypage-sidebar-item" data-mycate="2"><p>좋아요</p></div>
                    <div class="mypage-sidebar-item" data-mycate="3"><p>플래너</p></div>
                </div>
